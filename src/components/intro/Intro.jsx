  ...
  return (
      <div className="intro" id="intro">
        ...
        <div className="wrapper">
          ...
          <h3 style={{ marginTop: "10px" }}>I'm from Delhi</h3>
          <button className="btn" onClick={() => window.open("assets/aashishresume.pdf", "_blank")}><span><DescriptionIcon style={{height:"17px", width:"20px"}}/></span>Resume</button>
        </div>
        <a href="#portfolio">
